...
def predict():
    ...
    if output>str(0.5):
        ...
        return render_template('result.html', pred=f'You have a low chance of diabetes which is currently considered safe. This is only an example, please consult a doctor for any medical advice.\n Probability of having diabetes is {output}')
